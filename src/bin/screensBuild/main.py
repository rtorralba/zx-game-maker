...
from helper import getOsSeparator, getZx0
...
def process_screen(screen_name):
    run_command(BIN_FOLDER + getZx0() + " -f " + SCREENS_FOLDER + screen_name + ".scr " + OUTPUT_FOLDER + screen_name + ".png.scr.zx0")
...
if enabled128K:
    ...
    if os.path.isfile(SCREENS_FOLDER + "intro.scr"):
        run_command(BIN_FOLDER + getZx0() + " -f " + SCREENS_FOLDER + "intro.scr " + OUTPUT_FOLDER + "intro.scr.zx0")
    ...
    if os.path.isfile(SCREENS_FOLDER + "gameover.scr"):
        run_command(BIN_FOLDER + getZx0() + " -f " + SCREENS_FOLDER + "gameover.scr " + OUTPUT_FOLDER + "gameover.scr.zx0")

#include "../output/config.bas"
    ...
    Dim messageCoolDown as Ubyte = 0
    Const MESSAGE_COOLDOWN_LOOPS as Ubyte = 100
#endif
...
Const ENEMY_BEHAVIOUR_DEFAULT_SHOOT As Ubyte = 1
#ifdef RECTANGULAR_MOVE_ENABLED
    Const ENEMY_BEHAVIOUR_RECTANGULAR As Ubyte = 2
    Const ENEMY_BEHAVIOUR_RECTANGULAR_SHOOT As Ubyte = 3
#endif
Const ENEMY_BEHAVIOUR_STALKER As Ubyte = 4
Const ENEMY_BEHAVIOUR_STALKER_SHOOT As Ubyte = 5
Const ENEMY_BEHAVIOUR_NO_RETURN As Ubyte = 6    

...
class ChartGenerator:
    def execute(self, sizes: Sizes, is128k):
        ...
        if is128k:
            ...
            paramsMap3 = "Vortex-Player:" + str(sizes.VTPLAYER) + ",Title-Music:" + str(sizes.MUSIC_TITLE) + ",Ingame-Music:" + str(sizes.MUSIC) + ",Ingame-2-Music:" + str(sizes.MUSIC_2) + ",Ingame-3-Music:" + str(sizes.MUSIC_3) + ",Ending-Music:" + str(sizes.MUSIC_ENDING) + ",GameOver-Music:" + str(sizes.MUSIC_GAMEOVER) + ",Goal-Music:" + str(sizes.MUSIC_ARCADE_GOAL_ACHIEVED) + ",Intro-Music:" + str(sizes.MUSIC_INTRO) + " memory-bank-3.png"
